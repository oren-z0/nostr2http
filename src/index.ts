...
if (esMain(import.meta)) {
 ...
 this case). The relays in the file should be separated by space or new-lines.'
    ...
    .requiredOption('--nsec-file <filename>', 'Listen to nostr messages to this nsec.')
    .option('--save-nsec', 'If the nsec file was not found, generate a random nsec and save it in the same path.')
    .option('--save-npub-file <filename>', 'Save the npub of used nsec. Useful for other processes to read it.')
    .option(
 ...
 rewrites and redirects we recommend installing a separated reverse-proxy."
    ...
    .option('--nprofile-max-relays', 'Max number of relays to include in the printed NIP-19 nprofile entity', '5')
    .option(
      '--exit-on-file-change',
